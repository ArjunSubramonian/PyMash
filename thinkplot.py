...
def HexBin(xs, ys, **options):
    ...
    options = _Underride(options, cmap=Blues)
...
def Contour(obj, pcolor=False, contour=True, imshow=False, **options):
    ...
    _Underride(options, linewidth=3, cmap=matplotlib.cm.get_cmap)
...
def Pcolor(xs, ys, zs, pcolor=True, contour=False, **options):
    ...
    options: keyword args passed to plt.pcolor and/or plt.contour
    """
    _Underride(options, linewidth=3, cmap=matplotlib.cm.get_cmap().Blues)
